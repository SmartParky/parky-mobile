...
import { View, Image, Dimensions, TextInput, Text, Picker, PickerItem } from 'react-native';
...
import { createRezervation, inputChange, ListPark, ListCar } from '../actions';
...
class CreateRezervation extends Component {
  constructor(props){
    super(props)
    this.state = {
      baslangicSaati: "05.01.2019 12:00",
      bitisSaati: "05.01.2019 13:00"
    }
  }
  componentWillMount() {
      this.props.ListPark();
          ...
          <View style={{ paddingHorizontal: 128, paddingTop: 20, flex: 1 }}>
            <View style={ styles.PickerView }>
                <Picker
                    ...
                    onValueChange={otopark => this.props.inputChange({ props: 'otopark', value: otopark })}
                >
                    {_.map(this.props.parks, name =>
                        <Picker.Item key={name.id} label={name.name} value={name.id} />
                    )}
                </Picker>
            </View>
          </View>
          ...
          <View style={{ paddingHorizontal: 128, paddingTop: 10, flex: 1 }}>
            <View style={ styles.PickerCar }>
                <Picker
                    ...
                    onValueChange={arac => this.props.inputChange({ props: 'arac', value: arac })}
                >
...
export default connect(mapToStateProps, { createRezervation, inputChange, ListPark, ListCar })(CreateRezervation);
